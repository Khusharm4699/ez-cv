...
looks — pick whichever fits the role and the reader:

- **Terminal** — a scrolling dev-console aesthetic.
- **AI-assistant** — your story as a chat with an AI, with tool-call cards.
- **Editorial** — light, print-grade, recruiter-friendly.
- **Sidebar** — modern two-column with an accent rail.
...
…plus ATS Markdown, LaTeX, and one-page variants of each. See them rendered below.

## Built with EZ-CV — my own résumé

Here is the **real thing**: my own résumé in all four styles, generated by this exact
engine and live on GitHub Pages. Click any image to open the live page.
